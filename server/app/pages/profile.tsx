  ...
  return (
    <>
      ...
      <div>
        <label class="field">
          <span>
            <Locale en="User ID: " zh_hk="用戶編號: " zh_cn="用户编号: " />
          </span>
          <span>{user_id}</span>
        </label>
      </div>
        ...
        <div id="previewContainer" hidden>
          <div
            ...
            data-preview-message={
              <Locale en="Image Preview" zh_hk="圖片預覽" zh_cn="图片预览" />
            }
          ></div>
          <img id="previewImg" />
          <br />
          <input
            type="submit"
            value={
              <Locale en="Upload Avatar" zh_hk="上傳頭像" zh_cn="上传头像" />
            }
          />
        </div>
    ...
    <>
      ...
      <p>
        <Locale
          en={
            <>
              You can go to <Link href="/app/project">project list</Link> to
              explore and manage your projects.
            </>
          }
          zh_hk={
            <>
              您可以前往 <Link href="/app/project">項目列表</Link>{' '}
              以探索和管理您的項目。
            </>
          }
          zh_cn={
            <>
              您可以前往 <Link href="/app/project">项目列表</Link>{' '}
              以探索和管理您的项目。
            </>
          }
        />
